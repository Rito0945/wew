      ...
      <section className="container">
        ...
        <div className="about">
          ...
          <div className="hero-content">
            <p>
elcome to HealthBooker, your go-to platform for seamless access to healthcare services. At HealthBooker, we're committed to revolutionizing the way you manage your health journey.
